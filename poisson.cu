...
// poisson_jacobi_autotune_online.cu
// ONLINE AUTOTUNE: try one (bx,by) per iteration at the start, pick best, then continue
// Build: nvcc -O3 -arch=sm_80 -DTYPE=double poisson_jacobi_autotune_online.cu -o poisson
